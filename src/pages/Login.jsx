...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (err.message?.includes('Email non confirmé') || err.message?.includes('non confirmé')) {
                    ...
                    {emailNotVerified && (
                      <div className="mt-2 space-y-1">
                        <button
                          ...
                          className="text-sm text-teal-600 hover:text-teal-700 font-medium underline block"
                        >
